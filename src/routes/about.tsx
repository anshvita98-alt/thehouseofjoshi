      ...
      <Section eyebrow="OUR PURPOSE" title={<>Building a kingdom of <span className="gold-text">permanence</span></>}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glass rounded-2xl p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">A multichain sovereign empire — DAO governance, generational vaults, NFT launchpads, creative tooling, and educational realms — all designed to outlast generations.</p>
          </div>
        </div>
      </Section>
