...
const SECTIONS = [
  ...
  { id: "infrastructure", title: "Multi-Chain Infrastructure", body: "The protocol's multichain architecture spans Base, Ethereum, Polygon, BNB Chain, Arbitrum, Optimism, Avalanche, Unichain, Robinhood Chain, Cronos and the XRP Ledger (XRP), with USDC on Base as the canonical settlement asset. Cross-chain messaging enables a unified user experience while preserving the sovereignty of each underlying network." },
