...
const FAQS: { q: string; a: string }[] = [
  { q: "What is House of Joshi?", a: "House of Joshi is a sovereign Web3 ecosystem on Base — combining a swap, NFT launchpad, Legacy Vault, Dreamweaver, staking and DAO treasury into one heritage-driven kingdom." },
