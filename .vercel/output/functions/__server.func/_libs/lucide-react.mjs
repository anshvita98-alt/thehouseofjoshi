...
const Baby = createLucideIcon("baby", __iconNode$o);
...
const FilePenLine = createLucideIcon("file-pen-line", __iconNode$j);
const __iconNode$i = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const Infinity = createLucideIcon("infinity", __iconNode$g);
const __iconNode$f = [
...
const Store = createLucideIcon("store", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
...
const Vault = createLucideIcon("vault", __iconNode$2);
const __iconNode$1 = [
