...
import { a as HTTPError, d as defineHandler, h as handleCacheHeaders, c as toResponse, b as defineLazyEventHandler, H as H3Core } from "./_libs/h3.mjs";
...
const findRouteRules = /* @__PURE__ */ (() => {
  const $0 = [{ name: "headers", route: "/assets/**", handler: headers, options: { "cache-control": "public, max-age=31536000, immutable" } }], $1 = [{ name: "cache", route: "/**", handler: cache, options: false }, { name: "isr", route: "/**", options: false }];
  return (m, p) => {
    let r = [];
...
const _lazy_MW2Oyp = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_MW2Oyp };
  return ((_m, p) => {
